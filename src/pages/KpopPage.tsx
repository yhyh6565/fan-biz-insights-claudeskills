...
const KpopPage = () => {
  const { data: articles = [], isLoading } = useArticles("K-POP");
  useScrollToTop();
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <div className="border-b bg-kpop-50/30">
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-6xl mx-auto">
              <h1 className="text-4xl font-bold text-kpop-700 mb-4">K-POP</h1>
              <p className="text-lg text-muted-foreground">
                K-POP 팬덤 비즈니스와 글로벌 전략을 분석합니다
              </p>
            </div>
          </div>
        </div>
